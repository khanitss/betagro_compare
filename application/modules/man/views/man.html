                ...
                <li class="dropdown menu-tasks hidden-xs">
                    ...
                    <div class="dropdown-menu pull-right dropdown-menu-lg">
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="18"
                                aria-valuemin="0" aria-valuemax="90
                                " style="width: 18%">
...
<section id="main">
  ...
  <div class="nav-menu-wrapper mcs-overflow1">
    <ul class="nav-menu">
      ...
      <li class="nav-item">
        <a href="index.html"><i class="zmdi zmdi-palette"></i>&nbsp;<span>Home</span></a>
    </li>
...
<section id="content">
   <div class="container">
    ...
    <div class="row">
        <form method="get">
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="thumbnail img-check">
                        <center><a href= "edit-man.html"><label for="cb1"> <img src="http://elanyeri.com/images/AdverImages/27/12041301524825.jpg"  alt="light" width="250" height="300"></center></a>
                        <div class="caption">
         ...
         <div class="col-md-3">
            <div class="thumbnail img-check">
                <center><a href= "edit-man.html"><label for="cb1"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmO3y5dkgWXkdKF7oOicCxQgDaPt1vn6m9rlboqRySlybQ27Hs"  alt="light" width="250" height="300"> </center></a>
                <div class="caption">
 ...
 <div class="col-md-3">
    <div class="thumbnail img-check">
        <center><a href= "edit-man.html"><label for="cb1"> <img src="http://img2.stockfresh.com/files/i/iodrakon/m/49/930660_91485537.jpg"  alt="light" width="250" height="300"> </center></a>
        <div class="caption">
...
<div class="col-md-3">
    <div class="thumbnail img-check">
        <center><a href= "edit-man.html"><label for="cb1"> <img src="http://th-live-01.slatic.net/p/3/buga-gas-refill-132ml-3-1243-5278166-7d9b6e837037c849eb6067158e0982fe-product.jpg"  alt="light" width="250" height="300"> </center></a>
        <div class="caption">
...
<div class="col-md-3">
    <div class="thumbnail img-check">
        <center><label for="cb1"> <a href= "edit-man.html"><img src="https://lh5.googleusercontent.com/-F0EnuXffkxw/UPrLckZIsiI/AAAAAAAAGT0/NCzZKAwFYEE/s512/worldgas-15-kg.jpg"  alt="light" width="250" height="300"></center></a>
        <div class="caption">
...
<div class="col-md-3">
    <div class="thumbnail img-check">
        <label class=" btn btn-light">
            <a href="add-man.html" type="button" class="btn btn-link"><img src="dist/images/icons/addButton.png" width="50%"></a>
    ...
    $(document).ready(function() {
      ...
      0);
       ...
       $('.btn-move-up').click(function() {
           $('.card-reveal').css({'display': 'block', 'transform': 'translateY(-90
            %)'});
       });
