      ...
      <div class="card">
        ...
        <div class="fileinput fileinput-new card-body card-padding" data-provides="fileinput" align="center">
          <span class="btn btn-default btn-file m-r-10">
                <span class="fileinput-new"><img src="dist/images/icons/addButton.png" width="75%" alt=""></span>
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="card">
        ...
        <div align="center">
          <a href="#">
              <img src="dist/images/icons/addButton.png" data-toggle="modal" data-target="#myAddRawModal" alt="addRaw" style="width:50%">
            </a>
        </div>
...
<span class="sr-only">Next</span>
    ...
    <div class="col-sm-4">
      <div class="card">
        ...
        <div align="center">
          <a href="#">
              <img src="dist/images/icons/addButton.png" data-toggle="modal" data-target="#myAddEquipModal" alt="addEquip" style="width:50%">
            </a>
        </div>
...
<div>
  <div class="row">
    ...
    <div class="col-sm-2 col-xs-5">
      <a type="button" href="#" class="btn btn-primary btn-lg btn-block m-t-10">submit</a>
    </div>
    <div class="col-sm-2 col-xs-5">
      <a type="button" href="#" class="btn btn-danger btn-lg btn-block m-t-10">back</a>
    </div>
